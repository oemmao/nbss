			...
			<ul class="nav navbar-nav ">
				<li class="dropdown disabled"><a href="#"
					...
					<ul class="dropdown-menu" role="menu">
						<li class="disabled"><a href="<%=route %>/member/memberPage.jsp" class="menu-font">정보수정</a></li>
						<li class="disabled"><a href="<%=route %>/myPage/myOrderList.jsp" class="menu-font">내가 받은 책
								목록</a></li>
					</ul>
				<li class="disabled"><a href="<%=route %>/product/productList.jsp" class="menu-font">정기배송</a></li>
				<li class="disabled"><a href="<%=route %>/board/boardMain.jsp" class="menu-font">커뮤니티</a></li>
				<li class="disabled"><a href="<%=route %>/help/help.jsp" class="menu-font">도움말</a></li>
				<li class="dropdown"><a href="#" class="dropdown-toggle menu-font"
